...
const Product = ({post}) => {
    ...
    return (
        ...
        hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] hover:shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]">
            <div>
